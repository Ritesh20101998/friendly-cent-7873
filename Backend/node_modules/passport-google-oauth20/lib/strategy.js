// Load modules.
var OAuth2Strategy = require('passport-oauth2/lib')
  , util = require('util')
  , uri = require('url')
  , GooglePlusProfile = require('passport-google-oauth20/lib/profile/googleplus')
  , OpenIDProfile = require('passport-google-oauth20/lib/profile/openid')
  , InternalOAuthError = require('passport-oauth2/lib').InternalOAuthError
  , GooglePlusAPIError = require('passport-google-oauth20/lib/errors/googleplusapierror')
  , UserInfoError = require('passport-google-oauth20/lib/errors/userinfoerror');
